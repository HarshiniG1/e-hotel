...
🔍 Search rooms using multiple filters (dates, price, capacity, location)

🏨 Support for multiple hotel chains and hotels

📅 Online room booking system

🛎 Direct renting when customers arrive without a booking

🧾 Archive system preserving historical booking and renting data

📊 SQL queries, triggers, indexes, and views
